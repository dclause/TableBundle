...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ->children()
                ->scalarNode('template')
                    ->defaultValue('@EMCTable/template.html.twig')
                ->end()
                ->scalarNode('default_extensions')
                    ->defaultValue('@EMCTable/extensions.html.twig')
                ->end()
                ...
                ->arrayNode('export')
                    ->children()
                        ...
                        ->arrayNode('pdf')
                            ->children()
                                ->scalarNode('template')
                                    ->defaultValue('@EMCTable/Export/pdf.html.twig')
                                ->end()
                                ->scalarNode('bin')
                        ...
                        ->arrayNode('xls')
                            ->children()
                                ->scalarNode('template')
                                    ->defaultValue('@EMCTable/Export/xls.xml.twig')
                                ->end()
                            ->end()
                        ->end()
                        ->scalarNode('template')
                            ->defaultValue('@EMCTable/Export/template.html.twig')
                        ->end()
                    ->end()
                ->end()
            ->end();
